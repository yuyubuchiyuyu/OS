...
public class CallInst extends Value {
    ...
    public CallInst(String resName, IrType irType, String funcName, FuncRParams funcRParams, SymbolTable symbolTable) {
    ...
    private ArrayList<String> argumentName = new ArrayList<>();
    private ArrayList<IrType> argumentIrType = new ArrayList<>();
    ...
    public ArrayList<Value> prepareInst() {
        ...
        if (funcRParams != null) {
            ...
            for (int i = 0; i < exps.size(); i++) {
                ...
                if (exp.judgeCalculate(symbolTable)) {    // 可计算
