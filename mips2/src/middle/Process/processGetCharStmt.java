...
public class processGetCharStmt {
    public static ArrayList<Value> processGetCharStmt(Stmt stmt, LLVMSymbolTable LLVMSymbolTable) {
        ...
        InputInst inputInst = new InputInst(inputName, new IrType(IrType.TypeID.IntegerTyID, 8));   // 得到的实际类型是i32
        instructions.add(inputInst);
        TransferInst.typeTransfer(instructions,new IrType(IrType.TypeID.IntegerTyID,8));    // i32转i8
        String storeName = instructions.get(instructions.size()-1).getResName();
